...
from toolcase.cache import MemoryCache, ToolCache, get_cache, reset_cache, set_cache
...
def test_redis_cache_sync() -> None:
    ...
    from toolcase.cache import RedisCache
...
async def test_async_redis_cache() -> None:
    ...
    from toolcase.cache import AsyncRedisCache
